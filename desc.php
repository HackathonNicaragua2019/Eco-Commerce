<?php
 ...
 $id = $_GET['idProducto'];
 $r = $conexion->LeerProductosXID($id);
...
<meta name="keywords" content="Ecommerce Nicaragua" />
...
<div class="banner-bootom-w3-agileits">
	<div class="container">
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="<?php echo $res['foto1']; ?>">
							<div class="thumb-image"> <img src="<?php echo $res['foto1']; ?>" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="<?php echo $res['foto2']; ?>">
							<div class="thumb-image"> <img src="<?php echo $res['foto2']; ?>" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="<?php echo $res['foto3']; ?>">
							<div class="thumb-image"> <img src="<?php echo $res['foto3']; ?>" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					</ul>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price">$<?php echo $res['precioVenta']; ?></span></p>
					<div class="rating1">
					...
					<!--/tab_one-->
					   <div class="tab1">
							...
							<div class="single_page_agile_its_w3ls">
							  <h6><?php echo $res['nombre']; ?></h6>
							   <p><?php echo $res['caracteristicas']; ?></p>
...
<div class="container"><br>
		    <h3 class="wthree_text_info">Productos relacionados</h3>		
						...
						<img src="<?php echo $foto1; ?>" alt="" class="pro-image-back">
						  <div class="men-cart-pro">
							<div class="inner-men-cart-pro">
							 <a href="single.html" class="link-product-add-cart">Ver Detalles</a>
							</div>
						  </div>
